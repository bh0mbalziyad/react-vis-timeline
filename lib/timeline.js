...
var _standalone = require("vis-data/standalone");

var _standalone2 = require("vis-timeline/standalone");
  ...
  (0, _createClass2["default"])(Timeline, [{
    ...
    value: function componentDidMount() {
      Object.defineProperty(this, 'timeline', {
        value: new _standalone2.Timeline((0, _classPrivateFieldGet2["default"])(this, _ref).current, this.items, this.groups, this.props.options),
        writable: false
      });
